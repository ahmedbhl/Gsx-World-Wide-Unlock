...
<h2>LIST OF IMEI PENDING FROM CUSTOMER</h2>
...
<center>
	...
	<tr>
      ...
      <th ><i><div align="center"><b>TYPE</b></div></i></th>

      <th ><i><div align="center"><b>COSTUMER</b></div></i></th>

	   <th ><i><div align="center"><b>DATE </b></div></i></th>
...
$etat=$row['etat'];
    ...
    <tr>
      ...
      <td><div align="center"><em><?php print $row['imei']; ?></em></div></td>
		...
		<td><div align="center" ><em><?php if($etat=='1'){echo '<span class="label label-success">'; $etat="UNLOCKED";}else { echo '<span class="label label-important">'; $etat="ON HOLD";} print $etat; ?></em></div></td></td>
