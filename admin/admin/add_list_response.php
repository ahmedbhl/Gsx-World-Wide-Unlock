...
<div class="widget-content" style="display: block;">
    ...
    <div class="logsin">
            ...
            <h2>SET RESPONSE TO COTUMER WITH FULL CHECK</h2>

	  <form action="add_list_response_action.php" method="POST" enctype="multipart/form-data" name="addProductForm" id="addProductForm">
