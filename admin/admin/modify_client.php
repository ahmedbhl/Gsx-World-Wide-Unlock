...
<center>
    ...
    <form action="modify_client_action.php" method="Post">
...
$etat=$g->verif_etat($row['etatadmin']);
    ...
    <tr>
	  ...
	  <td><div align="center"><em><a href="activer_action.php?id=<?php print $row['pseudo'];?>" class="btn btn-sm btn-default"><i class="icon-ok">ACTIVER</i></a></em></div></td>

      <td><div align="center"><em><a href="desactiver_action.php?id=<?php print $row['pseudo']; ?>" class="btn btn-sm btn-default"><i class="icon-ok">DESACTIVER</i></a></em></div></td>

      <td><div align="center"><em><a href="supprimer_action.php?id=<?php print $row['pseudo']; ?>" class="btn btn-sm btn-default"><i class="icon-ok">SUPPRIMER</i></a></em></div></td>
