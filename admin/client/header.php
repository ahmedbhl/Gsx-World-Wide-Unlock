...
<ul class="nav navbar-nav navbar-right">
    ...
    <li class="dropdown">
        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
            ...
            <span class="username"><?php if(isset($_SESSION['nom']) && isset($_SESSION['prenom']) && isset($_SESSION['pseudo'])) {echo "M".' '.$_SESSION['nom'].' '.$_SESSION['prenom'];}else{echo "Mon Compte";} ?></span>
            <b class="caret"></b>
        </a>
        <!-- Dropdown menu -->
    ...
    <div class="sidebar sidebar-fixed">
        ...
        <div class="sidebar-inner">
           ...
           <ul class="navi">
                ...
                <li class="current"><a href=""><i class="icon-desktop"></i>Menu</a></li>
                ...
                <li class="has_submenu">
					...
					<ul>
                       	<li><a href="insert_imei.php">Insert IMEI</a></li>
                       	<li><a href="full_check.php">Full Check IMEI</a></li>
                        <li><a href="historique_check.php">Hystorique de check </a></li>
  ...
  <div class="mainbar">
    ...
    <div class="page-head">
            ...
            <div class="bread-crumb">
                <a href="accueil_client.php"><i class="icon-home"></i> Acceuil</a>
                <!-- Divider -->
            ...
            <div class="col-md-12">
                ...
                <div class="page-header">
                    <div class="ui-state-default">
                        <h3>Compte : <?php print $_SESSION['pseudo'];  ?></h3>
