...
<div class="navbar-header">
    ...
    <a href="../index-2.html" class="navbar-brand"><span class="bold">Enseignant</span></a></div>
...
<ul class="nav navbar-nav navbar-right">
    ...
    <li class="dropdown">
        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
            <i class="icon-male"></i>
            <span class="username">Enseignant</span>
            <b class="caret"></b>
        </a>
        <!-- Dropdown menu -->
        <ul class="dropdown-menu">
            
            <li><a href="connexion_admin.php"><i class="icon-off"></i> Logout</a></li>
        </ul>
    </li>
</ul>
...
<img src="../img/ajout_cours_icon.png" />
  	...
  	<div class="mainbar">
        ...
        <div class="page-head">
            ...
            <div class="bread-crumb">
                <a href="accueil_enseignant.php"><i class="icon-home"></i> Acceuil</a>
                <!-- Divider -->
          ...
          <div class="widget boxed">
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <!-- Form starts.  -->
                      <form class="form-horizontal" role="form" action="../../controlleurs/documents_control.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                    <input name="libelle_doc" type="text" class="form-control" placeholder="Input Box">
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                    <textarea name="resume_doc" rows="3" class="form-control" placeholder="Textarea"></textarea>
                                  </div>
                                </div>    
    ...
    <option value="tp">
    	...
    	<?php while($obj=mysql_fetch_object($resultat)){?>
        <option value="<?php echo $obj->id_cours ?>">
		<?php echo $obj->nom_cours;?></option>
	  ...
	  <?php }?>
                       ...
                       <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                    <input name="fichier" type="file" class="form-control" placeholder="Input Box">
                                  </div>
                                </div>
                                <hr>
                                <div class="form-group">
