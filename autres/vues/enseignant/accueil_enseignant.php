...
echo "<script> window.location='connexion_ens.php';</script>";
...
<ul class="nav navbar-nav navbar-left hidden-xs hidden-sm">
    ...
    <li>
        <a href="ajouter_document_ens.php">Ajouter Docment</a>
    </li>
    <li>
        <a href="../utilisateur.php">Bloquer Utilisateur</a>
    </li>
    <li class="dropdown">
...
<ul class="nav navbar-nav navbar-right">
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li class="divider"></li>
            <li><a href="connexion_ens.php"><i class="icon-off"></i> Deconnecter</a></li>
        </ul>
    </li>
</ul>
...
<div class="content">
    ...
    <div class="sidebar sidebar-fixed">
        ...
        <div class="sidebar-inner">
           ...
           <ul class="navi">
            <img src="../img/icone_enseignant.jpg">
            </ul>
            ...
            <div class="col-sm-6">
                ...
                <div class="page-header">
                    <div class="page-title">
                        <h3>Bienvenu Monsieur/Madame</h3>
                    </div>
