    ...
    <div class="sidebar sidebar-fixed">
        ...
        <div class="sidebar-inner">
            ...
            <ul class="navi">
                ...
                <li class="current"><a href="index-2.html"><i class="icon-desktop"></i> Dashboard</a></li>
            ...
            <ul class="crumb-buttons">
                ...
                <li class="range">
                    <a href="calendar.html">
                        <i class="icon-calendar"></i>
                        <span>September 9, 2013 - October 8, 2013</span>
                    </a>
                </li>
            </ul>
          ...
          <div class="row statistics">
              <div class="col-md-3 col-sm-6">
                  <ul class="today-datas">
                      ...
                      <li class="overall-datas">
                          <!-- Graph -->
                          <div class="pull-left visual bred"><span id="todayspark1" class="spark"><canvas width="54" height="20" style="display: inline-block; width: 54px; height: 20px; vertical-align: top;"></canvas></span></div>
                          <!-- Text -->
                          <div class="datas-text pull-right">Visitors/Day <span class="bold">12,000</span></div>
              ...
              <div class="col-md-3 col-sm-6">
                  <ul class="today-datas">
                      ...
                      <li class="overall-datas">
                          <!-- Graph -->
                          <div class="pull-left visual bred"><span id="todayspark1" class="spark"></span></div>
                          <!-- Text -->
                          <div class="datas-text pull-right">Visitors/Day <span class="bold">12,000</span></div>
              ...
              <div class="col-md-3 col-sm-6">
                  <ul class="today-datas">
                      <li class="overall-datas">
                          ...
                          <!-- Text -->
                          <div class="datas-text pull-right">Members <span class="bold">30,000</span></div>
                  ...
                  <ul class="today-datas">
                      <li class="overall-datas">
                          <!-- Graph -->
                          <div class="pull-left visual blightblue"><span id="todayspark2" class="spark"><canvas width="54" height="20" style="display: inline-block; width: 54px; height: 20px; vertical-align: top;"></canvas></span></div>
                          <!-- Text -->
                          <div class="datas-text pull-right">Bounce Rate <span class="bold">15.66%</span></div>
              ...
              <div class="col-md-3 col-sm-6">
                  <ul class="today-datas">
                      <li class="overall-datas">
                          <!-- Graph -->
                          <div class="pull-left visual blightblue"><span id="todayspark2" class="spark"></span></div>
                          <!-- Text -->
                          <div class="datas-text pull-right">Bounce Rate <span class="bold">15.66%</span></div>
              ...
              <div class="col-md-3 col-sm-6">
                  <ul class="today-datas">
                      <li class="overall-datas">
                          <!-- Graph -->
                          <div class="pull-left visual borange"><i class="icon-dollar"></i></div>
                          <!-- Text -->
                          <div class="datas-text pull-right">Total Profit <span class="bold">$22,000</span></div>
