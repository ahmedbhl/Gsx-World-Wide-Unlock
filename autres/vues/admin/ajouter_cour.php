...
<img src="../img/ajout_cours_icon.png" />
    ...
    <!-- Sidebar ends -->
  	...
  	<div class="mainbar">
        ...
        <div class="page-head">
            ...
            <div class="bread-crumb">
                ...
                <!-- Divider -->
               <a href="gestion_cours.php"><span class="divider">>Gestion Cours</span>
                </a>
            </div>
        ...
        <div class="container">
          ...
          <div class="widget boxed">
                ...
                <div class="widget-head">
                  <h4 class="pull-left"><i class="icon-reorder"></i>Forms</h4>
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <!-- Form starts.  -->
                      <form class="form-horizontal" role="form" action="../../controlleurs/cours_control.php" method="post">
                              
                                <div class="form-group">
                                  <label class="col-lg-4 control-label">Categorie</label>
                                  <div class="col-lg-8">
                                    <select name="id_categ" class="form-control">
                                  
    	<?php while($obj1=mysql_fetch_object($res)){?>
        <option value="<?php echo $obj1->libelle_categ; ?>">
		<?php echo $obj1->libelle_categ?></option>
	  ...
	  <?php }?>
                                ...
                                <div class="form-group">
                                  <label class="col-lg-4 control-label">Nom_Cours</label>
                                  <div class="col-lg-8">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                    <textarea name="description" rows="3" class="form-control" placeholder="Textarea"></textarea>
                                  </div>
                                </div>    
                       ...
                       <div class="form-group">
                                  <label class="col-lg-4 control-label">Propriétaire</label>
                                  <div class="col-lg-8">
                                    <select name="id_enseignant" class="form-control">
                                  
    	<?php while($obj=mysql_fetch_object($resultat)){?>
        <option value="<?php echo $obj->id_enseignant; ?>">
		<?php echo $obj->nom_enseignant.' '.$obj->prenom_enseignant; ?></option>
