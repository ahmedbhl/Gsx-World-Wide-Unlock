...
$ens=new Enseignant();
$res=$ens->details_enseignant($id_etud);
echo "var_dump($res)";
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="sidebar sidebar-fixed">
        ...
        <div class="sidebar-inner">
            ...
            <ul class="navi">
               ...
               <img src="../img/edit-icon.png"> <!-- Use the class nred, ngreen, nblue, nlightblue, nviolet or norange to add background color. You need to use this in <li> tag. -->
  	...
  	<div class="mainbar">
        ...
        <div class="page-head">
          ...
          <div class="bread-crumb">
                ...
                <!-- Divider -->
                <span class="divider">></span><a href="gestion_enseignant.php">Gestion enseignant</a></div>
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <!-- Form starts.  -->
                     ...
                     <form class="form-horizontal" role="form" action="../../controlleurs/enseignant_control.php?action=modifier_ensei" enctype="multipart/form-data" method="post">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                    <input name="email" type="text" class="form-control" value="<?= $obj->email_enseignant?>">
                                  </div>
                                </div>
                                  ...
                                  <div class="col-lg-8">
                                    <input name="nom" type="text" class="form-control" value="<?= $obj->nom_enseignant?>">
                                  </div>
                                </div>
                                <div class="form-group">
                                  <label class="col-lg-4 control-label">Prenom</label>
                                  <div class="col-lg-8">
                                    <input name="prenom" type="text" class="form-control" placeholder="Input Box" value="<?php  echo "$obj->prenom_enseignant"?>">
                                  </div>
                                </div>
                                
                                <div class="form-group">
<label class="col-lg-4 control-label">Password</label>                                  <div class="col-lg-8">
                                    <input name="pass" type="text" class="form-control" value="<?= $obj->password_enseignant;?>">
                                  </div>
                                </div>
                                ...
                                <input type="hidden" value="<?php echo $obj->id_enseignant; ?>" name="id">
