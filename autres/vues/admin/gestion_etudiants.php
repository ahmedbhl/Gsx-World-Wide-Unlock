...
$res=$inscrit->liste_etudiant_inscrit($startRow_liste_etudiant,$maxRows_liste_etudiant);
...
if (isset($_GET['totalRows_liste_etudiant'])) {
  ...
  $all_liste_etudiant =$inscrit->liste_etudiant_inscrit_total();
  	...
  	<div class="mainbar">
        ...
        <div class="page-head">
            ...
            <div class="bread-crumb">
                ...
                <a href="gestion_etudiants.php" class="bread-current">Gestion des etudiants</a>
            </div>
                  ...
                  <div class="widget-content">
                    ...
                    <table class="table table-hover table-striped ">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?php echo $obj->idinscrit?></td>
                          <td><?php echo $obj->nom?></td>
                          <td><?php echo $obj->prenom?></td>
                          <td><?php echo $obj->adressemail?></td>
                          ...
                          ?>
                          <span class="label label-important">Non Active</span>
                         <?php } ?> 
                          </td>
                          <td>
				<?php if($obj->status==0){ ?>
                              <button class="btn btn-sm btn-success"><a href="confirmation_inscription.php?id_etud=<?php echo $obj->idinscrit?>"><i class="icon-ok"></i></a> </button>
                              <?php }?>
                              <button class="btn btn-sm btn-warning"><a href="modifier_inscription.php?id_etud=<?php echo $obj->idinscrit?>"><i class="icon-pencil"></i> </a></button>
                              <button class="btn btn-sm btn-danger"><a href="supprimer_inscription.php?id_etud=<?php echo $obj->idinscrit?>"><i class="icon-remove"></i> </a></button>
