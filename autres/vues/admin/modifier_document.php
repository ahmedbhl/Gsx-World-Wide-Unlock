...
$doc=new Documents();
$resultat=$doc->details_document_by_id($id_doc);

$obj=mysql_fetch_object($resultat);


$cour=new Cours();
$res_cour=$cour->liste_cours();
...
<div class="navbar-header">
    ...
    <a href="../index-2.html" class="navbar-brand"><span class="bold">Administration</span></a></div>
...
<ul class="navi">
<img src="../img/ajout_cours_icon.png" />
</ul>
  	...
  	<div class="mainbar">
        ...
        <div class="page-head">
            ...
            <div class="bread-crumb">
                ...
                <!-- Divider -->
                <span class="divider">><a href="gestion_cours.php">Gestion Cours</a></span>
          ...
          <div class="widget boxed">
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <!-- Form starts.  -->
                      <form class="form-horizontal" role="form" action="../../controlleurs/modifier_doc_control.php" method="post" enctype="multipart/form-data">
                              
                                
                                
                                <div class="form-group">
                                  <label class="col-lg-4 control-label">Nom Document</label>
                                  <div class="col-lg-8">
                                    <input name="libelle_doc" type="text" class="form-control" placeholder="Input Box" value="<?php echo $obj->libelle_doc;?>">
                                  </div>
                                </div>
                                
                                <div class="form-group">
                                  <label class="col-lg-4 control-label">Resume</label>
                                  <div class="col-lg-8">
                                    <textarea name="resume_doc" rows="3" class="form-control" placeholder="Textarea"><?php echo $obj->resume_doc;?></textarea>
                                  </div>
                                </div>    
                       ...
                       <div class="form-group">
                                  <label class="col-lg-4 control-label">Type cour</label>
                                  <div class="col-lg-8">
                                    <select name="type" class="form-control">
                                  
    <option value="tp" <?php if($obj->type=='tp'){ echo "selected=selected"; }?> >
    		TP
		</option>
        <option value="td" <?php if($obj->type=='td'){ echo "selected=selected"; }?>>
		TD</option>
        <option value="cour" <?php if($obj->type=='cour'){ echo "selected=selected"; }?>>
		COUR</option>
                       ...
                       <div class="form-group">
                                  <label class="col-lg-4 control-label">Cour</label>
                                  <div class="col-lg-8">
                                    <select name="id_cour" class="form-control">
                                  
    	<?php while($obj_cour=mysql_fetch_object($res_cour)){?>
        <option value="<?php echo $obj_cour->id_cours ?>" <?php if($obj_cour->id_cours==$obj->id_cour){ echo "selected=selected"; }?>>
		<?php echo $obj_cour->nom_cours;?></option>
	  ...
	  <?php }?>
                       ...
                       <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                    ...
                                    <option value="0" <?php if($obj->etat_doc==0){ echo "selected=selected"; }?> >
                                            Non Actif
                                        </option>
                                        <option value="1" <?php if($obj->etat_doc==1){ echo "selected=selected"; }?>>
                                        Actif</option>
                       ...
                       <div class="form-group">
                                  <label class="col-lg-4 control-label">Fichier:</label>
                                  <div class="col-lg-8">
                                    <input name="fichier" type="file" class="form-control" placeholder="Input Box" value="">
   <input name="fichier2" type="hidden" class="form-control" value="<?php echo $obj->fichier; ?>">
   <input name="ext" type="hidden" class="form-control" value="<?php echo $obj->format_doc; ?>"> 
   <input name="id_doc" type="hidden" class="form-control" value="<?php echo $obj->id_doc; ?>"> 
                                  </div>
                                </div>
                                <hr>
                                <div class="form-group">
