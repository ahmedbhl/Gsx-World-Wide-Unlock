          ...
          <div class="widget boxed">
                ...
                <div class="widget-content medias">
                  ...
                  <table class="table table-bordered table-hover table-striped ">
                      ...
                      <tbody>
<?php 
while($obj_cat=mysql_fetch_object($res))
{
?>
                        <tr>
                          <td><?= $obj_cat->libelle_categ; ?></td>
                          <td>

     
                              <button class="btn btn-sm btn-info"> <a href="supprimer_cat.php?id_categ=<?php echo $obj_cat->id_categ;?>" onclick="return confirm('voulez vous supprimer le categorie?')"><i class="icon-remove"></i> </a></button>
