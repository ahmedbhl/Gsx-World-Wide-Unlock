...
$res_liste_doc=$document->liste_documents_existant($startRow_liste_documents,$maxRows_liste_documents);
...
<ul class="nav navbar-nav navbar-left hidden-xs hidden-sm">
    ...
    <li>
        <a href="ajouter_cour.php"> Ajouter Cours </a>
    </li>
    <li>
        <a href="ajouter_categorie.php"> Ajouter Categorie </a>
    </li>
    <li>
    ...
    <li>
        <a href="ajouter_document.php"> Ajouter Document </a>
    </li>
    </ul>
<!-- Notifications -->
...
?>
                        <tr>
                          ...
                          <td>
                              ...
                              <button class="btn btn-sm btn-danger"><a href="modifier_document.php?id_doc=<?php echo $obj_doc->id_doc;?>"><i class="icon-pencil"></i></a> </button>
                              <button class="btn btn-sm btn-info"> <a href="supprimer_cours.php?id_cour=<?php echo $obj_doc->id_doc;?>" onclick="return confirm('voulez vous supprimer le document?')"><i class="icon-remove"></i> </a></button>
