...
<div class="admin-form">
  <div class="container">
    <div class="row">
    <img src="../img/admin.jpg" width="563" height="196"/>
      <div class="col-lg-12">
        <!-- Widget starts -->
        <div class="logo"><a href="connexion_admin.php" class="navbar-brand"><span class="bold">AUthentification</span></a></div>
          <div class="widget">
              <!-- Widget head -->
              ...
              <div class="widget-content">
                  <div class="padd">
                      <!-- Login form -->
                      <form class="form-horizontal" action="../../controlleurs/admin_control.php" method="post">
                          <!-- Name -->
