...
$res3=$document->liste_document(); // resultat de la table documents
...
$res3=$document->liste_documents_existant($startRow_liste_documents,$maxRows_liste_documents);
...
<ul class="nav navbar-nav navbar-left hidden-xs hidden-sm">
    ...
    <li>
        <a href="admin/ajouter_cour.php"> Ajouter Cours </a>
    </li>
    <li>
        <a href="admin/ajouter_categorie.php"> Ajouter/Supprimer Categorie </a>
    </li>
    </ul>
<!-- Notifications -->
<ul class="nav navbar-nav navbar-right">
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li><a href="connexion_etudiant.php"><i class="icon-off"></i> Logout</a></li>
        </ul>
    </li>
</ul>
                    ...
                    <ul>
                      <?php
					  	$res2=$cour->liste_cour_by_categ($obj1->id_categ);
                        	...
                        	<li><a href="gestion_cours.php?action=cours&id_cours=<?php echo $obj2->id_cours;?>"><?php echo $obj2->nom_cours;?></a></li>
                       	<?php }?>
  ...
  <div class="mainbar">
    ...
    <div class="page-head">
            ...
            <div class="bread-crumb">
                <a href="admin/accueil_admin.php"><i class="icon-home"></i> Home</a>
                <!-- Divider -->
...
?>
                        <tr>
                          ...
                          <td><img src="img/<?php echo $obj_doc->format_doc.'.jpg' ;?>"></td>
                          ...
                          <td>
                              ...
                              <button class="btn btn-sm btn-danger"><i class="icon-pencil"></i> </button>
                              <button class="btn btn-sm btn-info"> <a href="admin/supprimer_cours.php?id_etud=<?php echo $obj->id_cours?>"><i class="icon-remove"></i> </a></button>
