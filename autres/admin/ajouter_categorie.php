...
<img src="../img/icon_categ.png" />
    ...
    <!-- Sidebar ends -->
          ...
          <div class="widget boxed">
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <!-- Form starts.  -->
                     <form class="form-horizontal" role="form" action="../../controlleurs/categorie_control.php?action=ajout_categ" method="post">
	  ...
	  <?php }?>
                                ...
                                <div class="form-group">
                                  <label class="col-lg-4 control-label">Nouveau Categorie </label>
                                  <div class="col-lg-8">
                                    <input name="nomcateg" type="text" class="form-control" placeholder="Input Box">
                                  </div>
                                </div>
