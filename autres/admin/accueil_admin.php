...
<ul class="nav navbar-nav navbar-right">
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li><a href="deconnexion.php"><i class="icon-off"></i> Deconnecter</a></li>
        </ul>
    </li>
</ul>
              ...
              <div class="col-md-3 col-sm-6">
                  <ul class="today-datas">
                      ...
                      <li class="overall-datas">
                          ...
                          <!-- Text -->
                          <div class="datas-text pull-right">Gestionnaire <span class="bold">Etudiant</span></div>

                          <div class="clearfix"></div>
                      </li>
                      <li class="more-stats">
                          <a class="more" href="gestion_etudiants.php">
                             Plus de details
              ...
              <div class="col-md-3 col-sm-6">
                  <ul class="today-datas">
                      ...
                      <li class="overall-datas">
                          ...
                          <!-- Text -->
                          <div class="datas-text pull-right">Gestionnaire <span class="bold">Enseignant</span></div>

                          <div class="clearfix"></div>
                      </li>
                      <li class="more-stats">
                          <a class="more" href="gestion_enseignant.php">
                             Plus de details
                              <i class="pull-right icon-angle-right"></i>
                          </a>
                      </li>
              ...
              <div class="col-md-3 col-sm-6">
                  <ul class="today-datas">
                      <li class="overall-datas">
                          ...
                          <!-- Text -->
                          <div class="datas-text pull-right">Gestionnaire <span class="bold">Cours</span></div>

                          <div class="clearfix"></div>
                      </li>
                      <li class="more-stats">
                          <a class="more" href="gestion_cours.php">
                            Plus de details
                              <i class="pull-right icon-angle-right"></i>
                          </a>
                      </li>
