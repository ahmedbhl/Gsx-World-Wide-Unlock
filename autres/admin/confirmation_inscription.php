...
<head>
  ...
  function generer_password()
  {
	   var chars = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXTZabcdefghiklmnopqrstuvwxyz";
		...
		//alert(randomstring);
		document.form1.passe.value=randomstring;
		document.form1.copasse.value=randomstring;
  }
  </script>
...
<div class="content">
    ...
    <div class="sidebar sidebar-fixed">
        ...
        <div class="sidebar-inner">
            ...
            <ul class="navi">
            <img src="../img/confirmation_icon.png">
            </ul>
  	...
  	<div class="mainbar">
        ...
        <div class="page-head">
          ...
          <div class="bread-crumb">
                ...
                <!-- Divider -->
               <a href="gestion_etudiants.php"> <span class="divider">></span>Gestion Etudiants</a></div>
              ...
              <div class="widget boxed">
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <!-- Form starts.  -->
                     <form class="form-horizontal" role="form" action="../../controlleurs/inscription_control.php?action=activer_etud" method="post" name="form1">
                                ...
                                <input type="button" value="Generer un mot de passe" onClick="generer_password();"/>
                                ...
                                <input name="id_etudiant" type="hidden" value="<?php echo $obj->idinscrit;?>">
                                <input name="adressemail" type="hidden" value="<?php echo $obj->adressemail;?>">
