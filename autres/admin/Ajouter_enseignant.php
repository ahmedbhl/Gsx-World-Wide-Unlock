...
<div class="content">
    ...
    <div class="sidebar sidebar-fixed">
        ...
        <div class="sidebar-inner">
            ...
            <ul class="navi">
            <img src="../img/icon_ajout_ens.png">
            </ul>
  	...
  	<div class="mainbar">
        ...
        <div class="page-head">
          ...
          <div class="bread-crumb">
                ...
                <!-- Divider -->
                <span class="divider">></span><a href="gestion_enseignant.php">Gestions des enseignant</a></div>

            <ul class="crumb-buttons">
              <li class="range">
                  <a href="Ajouter_enseignant.php">
              ...
              <div class="widget boxed">
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <!-- Form starts.  -->
                     <form class="form-horizontal" role="form" action="../../controlleurs/ajout_enseignant_admin_control.php" enctype="multipart/form-data" method="post">
                              
                                <div class="form-group">
                                  <label class="col-lg-4 control-label">Email</label>
                                  <div class="col-lg-8">
                                    <input name="email" type="text" class="form-control" placeholder="Input Box">
                                  </div>
                                </div>
