              ...
              <div class="widget boxed">
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <!-- Form starts.  -->
                     <form class="form-horizontal" role="form" action="../../controlleurs/inscription_control.php?action=ajouter_etud" method="post">
                                ...
                                <input name="id_etudiant" type="hidden" value="">
