...
$ajout=new Enseignant();

$res=$ajout->liste_enseignant();
...
$res=$ajout->liste_enseignant_inscrit($startRow_liste_enseignant,$maxRows_liste_enseignant);
...
if (isset($_GET['totalRows_liste_enseignant'])) {
  ...
  $all_liste_enseignant = $ajout->liste_enseignant_inscrit_total();
...
<div class="navbar-header">
    ...
    <a href="accueil_admin.php" class="navbar-brand"><span class="bold">Administration</span></a></div>
...
<ul class="nav navbar-nav navbar-left hidden-xs hidden-sm">
    ...
    <li>
        <a href="gestion_etudiants.php"> Gestionnaire Etudiant </a>
    </li>
    <li>
        <a href="gestion_enseignant.php"> Enseignant </a>
    </li>
    <li>
        <a href="gestion_cours.php"> Cours </a>
    </li>
    <li class="dropdown">
...
<ul class="nav navbar-nav navbar-right">
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li><a href="connexion_admin.php"><i class="icon-off"></i> Déconnecter</a></li>
        </ul>
    </li>
</ul>
  	...
  	<div class="mainbar">
        ...
        <div class="page-head">
            ...
            <div class="bread-crumb">
                ...
                <a href="gestion_enseignant.php" class="bread-current">Gestion des Enseignats</a>
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="page-header">
                    <div class="page-title">
                        <h3>Tables des enseignants</h3>
                        <span><button type="button" class="btn btn-info">Ajout</button></span>
                    </div>
                  ...
                  <div class="widget-content">
                    ...
                    <table class="table table-hover table-striped ">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?php echo $obj->id_enseignant?></td>
                          <td><?php echo $obj->email_enseignant?></td>
                          <td><?php echo $obj->nom_enseignant?></td>
                         <td><?php echo $obj-> prenom_enseignant?></td>
                          <td><?php echo $obj->password_enseignant?></td>
                          <td><?php echo $obj->photo_enseignant?></td>
                          <td>

                              <button class="btn btn-sm btn-success"><a href="Ajouter_enseignant.php?id_etud=<?php echo $obj->id_enseignant?>"><i class="icon-ok"></i></a> </button>
                              <button class="btn btn-sm btn-warning"><a href="modifier_enseignant.php?id_etud=<?php echo $obj->id_enseignant?>"><i class="icon-pencil"></i> </a></button>
                              <button class="btn btn-sm btn-danger"><a href="supprimer_enseignant.php?id_etud=<?php echo $obj->id_enseignant?>"><i class="icon-remove"></i> </a></button>
